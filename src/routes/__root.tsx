...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "DFS — The D'Famocious Freelance Scholarship" },
      { name: "twitter:description", content: "An invitation-only training citadel by D'Famocious Group. We forge Digital Systems Experts and scale them globally in record time." },
