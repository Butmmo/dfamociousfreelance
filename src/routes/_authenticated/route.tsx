...
function AuthedShell() {
  ...
  // else (Calendar, Report, BPS, DFY, Mentorship, Council for admins).
  const tabs = [
  ...
  const moreLinks = [
    ...
    { to: "/report", label: "Report", icon: FileText, show: !needsChoice },
    { to: "/bps", label: "BPS", icon: Activity, show: !needsChoice },
    { to: "/dfy", label: "DFY Tracker", icon: DollarSign, show: !needsChoice },
