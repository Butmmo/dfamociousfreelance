...
export const Route = createFileRoute("/_authenticated/playbooks/broadcast-engine")({
  head: () => ({
    meta: [
      { title: "The Broadcast Engine — DFS Citadel" },
      { name: "description", content: "The Broadcast Engine: The 45-Day Build. Part of the DFS Citadel path system." },
      { property: "og:title", content: "The Broadcast Engine — DFS Citadel" },
