...
export const Route = createFileRoute("/_authenticated/playbooks/authority-calculator")({
  head: () => ({
    meta: [
      { title: "Authority Performance Calculator — DBI Citadel" },
      { name: "description", content: "Authority Performance Calculator: Powered by Claude AI. Part of the DBI Citadel path system." },
      { property: "og:title", content: "Authority Performance Calculator — DBI Citadel" },
