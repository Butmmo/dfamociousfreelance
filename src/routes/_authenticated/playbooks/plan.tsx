...
export const WEEKS = [
  {
    ...
    days:[
      ...
      {day:4, focus:"Build Your Review Automation Demo in GoHighLevel", icon:"🛠️",
       ...
       tasks:[
         ...
         {id:"4b",text:"Sign up for GoHighLevel's 30-day free trial (no card required) — see the GHL Mastery tab, step 01"},
         {id:"4c",text:"Create a demo sub-account for a fictional business in your chosen niche — GHL Mastery tab, step 02"},
         {id:"4d",text:"Build the 2-message Review Request workflow exactly as written in GHL Mastery tab, step 03: job-complete trigger → wait 2h → SMS 1 → wait 2h → SMS 2 with review link"},
         {id:"4e",text:"Test it end to end by sending it to your own phone number — confirm both messages land and the review link works"},
       ]},
      {day:5, focus:"Build Your Proof Assets", icon:"🎬",
       ...
       tasks:[
         {id:"5a",text:"Record a 2-minute 'review gap' video for a real Tier-1 business archetype in your niche — walk through their listing, their review count vs. a named competitor, and what the GHL workflow does about it. This is the video Email 1 (Scripts tab) offers to send"},
         {id:"5b",text:"In Lovable, build a simple branded 'Review Dashboard' mockup page showing review count growing over time — this becomes the $97/month reporting add-on described in the What to Pitch tab"},
         {id:"5c",text:"Publish the Lovable dashboard and open it on your phone — confirm it reads cleanly on mobile"},
         {id:"5d",text:"Write a 100-word description of the demo: the gap it shows, the fix it proves, the outcome it creates"},
       ]},
      {day:6, focus:"Record Loom Walkthroughs of Both Assets", icon:"🎬",
       note:"Keep each Loom under 90 seconds. Structure: the gap (10 sec) → the fix running live (60 sec) → what happens next (10 sec).",
       tasks:[
         {id:"6a",text:"Record a 60-90 second Loom of the GHL Review Automation workflow actually firing — the SMS arriving is the proof, show it live"},
         {id:"6b",text:"Record a 60-90 second Loom of the Lovable Review Dashboard"},
         {id:"6c",text:"Watch both recordings immediately — retake if your voice lacks confidence or any part of the demo freezes"},
         {id:"6d",text:"Save both Loom links in a Notion page titled 'Demo Assets' — the GHL Loom is what Email 1 (Scripts tab) offers to send"},
       ]},
    ...
    ]},
  {
    ...
    days:[
      {day:15, focus:"Draft Email 1 for Top 5 HOT Leads", icon:"✍️",
       ...
       tasks:[
         {id:"15a",text:"Open the Scripts tab — read Email 1 (The Gap) exactly as written before writing a single word. It asks permission to send a video. Nothing else."},
         {id:"15b",text:"For each of your top 5 HOT leads: swap in their business name, their competitor's name, and the specific review count gap you found during research"},
         {id:"15c",text:"Do not attach or mention the Lovable dashboard yet — Email 1 is about the review gap only. The Loom of your GHL workflow is what you are offering to send if they reply"},
    ...
    days:[
      ...
      {day:23, focus:"Send Email 3 to Non-Responders — The Lift", icon:"🎯",
       ...
       tasks:[
         ...
         {id:"23b",text:"Draft Email 3 for each exactly as written in the Scripts tab — it references a comparable client result, not a demo link"},
         {id:"23c",text:"If you have a real result by now, swap it in; if not, use your Day 6 Loom of the workflow firing on your demo account"},
         {id:"23d",text:"Send manually, update Notion Last Contacted"},
       ]},
      {day:24, focus:"Discovery Calls — SPIN Framework + the Performance Calculator", icon:"📞",
       ...
       tasks:[
         ...
         {id:"24f",text:"Open the SMB Performance Calculator (Playbooks menu) and enter their numbers live, screen-shared, on the call — their review count, competitor's review count, city population. This is the tool, not a slide deck: it turns 'we're losing customers' into an actual monthly dollar figure they watch build in real time"},
         {id:"24g",text:"Land on the Report tab — the total monthly revenue at risk and the #1 priority (almost always Review Automation for a Tier-1 lead) becomes the number you close on"},
       ]},
      {day:25, focus:"Send Your Proposal Within 24 Hours", icon:"📄",
       ...
       tasks:[
         {id:"25a",text:"One product, one price: Google Review Automation at $297-497/month (What to Pitch tab). Do not offer a 3-tier menu — see the FAQ 'Why do we only sell the Google Review Automation System to a new client?'"},
         {id:"25b",text:"Attach the Report tab from Tuesday's Performance Calculator session as the proposal's opening page — the number they watched build live is the reason to sign"},
         {id:"25c",text:"Include your delivery guarantee: 'Live within 48 hours of your first payment, or I work at no charge until it is'"},
         {id:"25d",text:"If they ask for a website: note it in Notion under the upsell ladder and hold the line — that is a Month 7+ conversation (Upsell Ladder tab), not today's proposal"},
       ]},
      ...
      {day:27, focus:"Handle Objections on Live Calls", icon:"🗣️",
       ...
       tasks:[
         {id:"27a",text:"'Too expensive' → Do not discount and do not offer a cheaper tier — there isn't one. Reframe value using the Performance Calculator number: 'At $297, this pays for itself the moment it recovers even a fraction of the $[X]/month you're already losing'"},
      ...
      {day:28, focus:"Close the First Month and Collect Payment", icon:"💰",
       ...
       tasks:[
         {id:"28a",text:"Once they say yes: send a simple 1-page agreement via Google Docs within the hour — one line item, $297-497/month, cancel anytime"},
         {id:"28b",text:"Send a Stripe payment link or Payoneer request for the first month — do not start work until payment clears"},
         {id:"28c",text:"Send a kickoff questionnaire: Google Business Profile access, a few recent completed-job examples, and the phone number their review requests should send from"},
         {id:"28d",text:"Update Notion Stage to 'Closed'. Begin building their live GHL sub-account immediately — see GHL Mastery tab, step 02."},
       ]},
    ]},
  {
    ...
    days:[
      {day:29, focus:"Set Up Their Live GHL Sub-Account", icon:"📐",
       ...
       tasks:[
         {id:"29a",text:"Create their sub-account in GHL and connect their Google Business Profile under Reputation → Settings — GHL Mastery tab, step 02"},
         {id:"29b",text:"Build their Review Request workflow exactly as tested on your demo: job-complete trigger → wait 2h → SMS 1 → wait 2h → SMS 2 with their review link"},
         {id:"29c",text:"Test it with your own number connected as a contact before it ever touches a real customer"},
         {id:"29d",text:"Send client update: 'Your system is built and tested — going live today. You will hear from me in 48 hours with your first results.'"},
       ]},
      {day:30, focus:"Go Live and Run a New Scouting Session", icon:"⚙️",
       ...
       tasks:[
         {id:"30a",text:"Flip the workflow live on their real job-completion trigger — send the client a Loom confirming it is active"},
      ...
      {day:33, focus:"First Results Call — Make It a Ceremony", icon:"🎉",
       ...
       tasks:[
         {id:"33a",text:"Book a 15-minute Calendly screen-share for their first-week results — do this even if only 1-2 reviews have landed so far"},
         {id:"33b",text:"Walk through the GHL Reputation dashboard live — show the review count, the workflow firing, and read one new review aloud together"},
         {id:"33c",text:"Confirm their card or payment method is set for the automatic renewal next month — no action needed from you if it is already on file from Day 28"},
         {id:"33d",text:"Schedule a Day-30 check-in now, on the call, before you hang up"},
       ]},
      {day:34, focus:"Upsell Conversation — Speed to Lead", icon:"📈",
       ...
       tasks:[
         {id:"34a",text:"Pull their contact-form submissions from the past 30 days and count how many got a callback within the hour — the gap is your opener"},
         {id:"34b",text:"Send the Month 3-4 intro line verbatim (Upsell Ladder tab): 'I pulled your form submissions from last month — you had [X] enquiries. Based on your response pattern, you're likely keeping about [X]%. Want me to make it automatic?'"},
         {id:"34c",text:"If they say yes: this is +$197-397/month on top of their existing $297-497/month Review Automation, not a separate deal — see What to Pitch tab"},
       ]},
    ...
    days:[
      ...
      {day:38, focus:"Draft Emails Using Your Real Case Study", icon:"✍️",
       ...
       tasks:[
         ...
         {id:"38b",text:"Example opener: 'I recently helped a [niche] business in [City] add [X] new reviews in their first month with zero extra effort on their end — happy to show you the exact system.'"},
